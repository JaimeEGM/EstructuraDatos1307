...
public class ListaDoble<E> {
	...
	/**
	 * Elimina el nodo de acuerdo al índice, devuelve un true si lo eliminó y false
	 * en caso contrario
	 * 
	 ...
	 *               alrevés. Fuera de rango obtiene el valor dando la veulta a la
	 *               lista
	...
	/**
	 * Cambia en la primera coincidencia el dato con el nuevo dato, si retorna true,
	 * cambia todos los datos de la lista simple, si retorna false solo cambia el
	 ...
	 *                  la lista
	 * @param todos     si true cambia en todas las coincidencias, si es falso solo
	 *                  cambia en 1
	 */
